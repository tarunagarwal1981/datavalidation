    ...
    with main_content:
        ...
        if st.button('Validate Data', key="validate_button"):
            try:
                ...
                # Fetch data only if any validation is selected
                if any([me_consumption_check, ae_consumption_check, boiler_consumption_check, 
                    ...
                    st.warning("Please select at least one validation criteria.")
